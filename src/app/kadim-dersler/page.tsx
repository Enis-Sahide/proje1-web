...
export default function KadimDerslerPage() {
  ...
  const userLvl = ROLE_LEVELS[role || 'free'] ?? 0;
  const filteredResources = (resourcesData ?? []).filter((r) => r.level <= userLvl);
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="text-center mb-16 animate-in fade-in duration-1000">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#D4AF37] text-xs font-semibold tracking-wider uppercase mb-4 shadow-[0_0_15px_rgba(212,175,55,0.15)]">
            ...
            <span>7Layers Ancient Knowledge Realm • Kadim Bilgiler Alanı</span>
          </div>
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto leading-relaxed">
            Ruhsal tekamülünüzü destekleyecek, binlerce yıllık kadim bilgileri barındıran ezoterik öğretilerimiz.
          </p>
        </div>
