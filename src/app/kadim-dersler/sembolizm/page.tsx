...
import { ArrowLeft, Lock, Sparkles, Shapes } from 'lucide-react';
import { useAuth } from '@/context/AuthContext';

export default function SembolizmPage() {
  ...
  return (
    <div className="min-h-screen pt-24 px-4 pb-12 relative flex flex-col items-center select-none bg-transparent">
      ...
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#1d1003] via-[#0a0501] to-[#000000] -z-50" />
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="mb-8 flex items-center">
          ...
          <div>
            ...
            <p className="text-mystic-text-muted mt-1 text-sm md:text-base italic">Ezoterik semboller, geometriler ve evrensel arketiplerin taşıdığı gizli frekanslar</p>
          </div>
        </div>
        ...
        {activeTab === 'cirak' && (
          <div className="animate-in fade-in duration-500 text-center py-20 bg-mystic-surface/30 border border-mystic-primary/20 rounded-3xl backdrop-blur-md max-w-md mx-auto">
            <Shapes className="text-mystic-primary mx-auto mb-4 animate-pulse" size={48} />
